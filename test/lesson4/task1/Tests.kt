...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("пятьдесят", russian(50))
        assertEquals("шестьсот три", russian(603))
        assertEquals("девятьсот", russian(900))
        assertEquals("восемь тысяч восемь", russian(8008))
        assertEquals("одиннадцать тысяч сто", russian(11100))
